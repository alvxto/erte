...
//   Acara({this.id, this.nama, this.kelamin, this.tempatlahir, this.tanggallahir, this.agama, this.status, this.wni, this.pendidikan, this.pekerjaan, this.nik, this.kk, this.alamat, this.keperluan, this.waktu});

//   Acara fromJson(DocumentSnapshot doc) {
...
//         // acaraCollection,
//       ),
//       // storageReference: storage.ref(acaraCollection)
//       );

//   Future<Acara> save() async {
