...
//   Kontrak({this.id, this.nama, this.kelamin, this.tempatlahir, this.tanggallahir, this.agama, this.status, this.wni, this.pendidikan, this.pekerjaan, this.nik, this.kk, this.alamat, this.keperluan, this.waktu});

//   Kontrak fromJson(DocumentSnapshot doc) {
...
//         kontrakCollection,
//       ),
//       storageReference: storage.ref(kontrakCollection));

//   Future<Kontrak> save() async {
