...
//   Kelahiran({this.id, this.nama, this.kelamin, this.tempatlahir, this.tanggallahir, this.agama, this.status, this.wni, this.pendidikan, this.pekerjaan, this.nik, this.kk, this.alamat, this.keperluan, this.waktu});

//   Kelahiran fromJson(DocumentSnapshot doc) {
...
//         kelahiranCollection,
//       ),
//       storageReference: storage.ref(kelahiranCollection));

//   Future<Kelahiran> save() async {
