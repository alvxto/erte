...
//   Kematian({this.id, this.nama, this.kelamin, this.tempatlahir, this.tanggallahir, this.agama, this.status, this.wni, this.pendidikan, this.pekerjaan, this.nik, this.kk, this.alamat, this.keperluan, this.waktu});

//   Kematian fromJson(DocumentSnapshot doc) {
...
//         kematianCollection,
//       ),
//       storageReference: storage.ref(kematianCollection));

//   Future<Kematian> save() async {
